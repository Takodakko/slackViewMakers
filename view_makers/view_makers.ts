...
/** Make a Slack Modal */
export const makeModal = (title: string, blocks: BlockElement[], id?: string, close?: string, submit?: string, pm?: string, clear?: boolean, notify?: boolean, exid?: string, noSubmit?: boolean) => {
