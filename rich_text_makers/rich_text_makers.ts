...
export const makeRichTextChannel = (
  id: string,
  style?:
    | "bold"
    | "italic"
...
export const makeRichTextList = (
  style: "bullet" | "ordered",
  elements: IRichTextSection[],
  indent?: number,
  offset?: number,
  border?: number,
) => {
...
export const makeRichTextUsergroup = (
  id: string,
  style?: {
    bold?: boolean;
    italic?: boolean;
